...
public class RoundImageView extends ImageView
{
	...
	private void setUpShader()
	{
		...
		} else if (type == TYPE_ROUND || type== TYPE_NOMAL)
		{
			Log.e("TAG",
	...
	protected void onDraw(Canvas canvas)
	{
		...
		}else if(type ==TYPE_NOMAL){
			canvas.drawRect(mRoundRect, mBitmapPaint);
		}
	}
	
	/**
	 * 当图形大小改变时,imageview大小的重置
	 */
	@Override
	protected void onSizeChanged(int w, int h, int oldw, int oldh)
	{
		...
		// 圆角图片的范围
		if (type == TYPE_ROUND || type == TYPE_NOMAL)
	...
	public void setType(int type)
	{
		if (this.type != type)
		{
			...
			//如果传进来的参数不对,设置默认值为TYPE_CIRCLE
			if (this.type != TYPE_ROUND && this.type != TYPE_CIRCLE && this.type != TYPE_NOMAL)
			{
